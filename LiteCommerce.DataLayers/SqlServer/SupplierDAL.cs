...
namespace LiteCommerce.DataLayers.SqlServer
{
    ...
    public class SupplierDAL : ISupplierDAL
    {
        ...
        /// <summary>
        /// Đếm số lượng bản ghi theo searchValue
        /// </summary>
        ...
        public int Count(string searchValue)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandText = @"select count(*) from Suppliers where @searchValue = N'' or CompanyName like @searchValue or ContactName like @searchValue or Phone like @searchValue";
                cmd.CommandType = CommandType.Text;
                cmd.Connection = connection;
                ...
                cmd.CommandText = @"select *
                                          ...
                                          (
	                                            select	row_number() over(order by CompanyName) as RowNumber,
			                                          Suppliers.*
	                                            from	Suppliers
	                                            where	(@searchValue = N'') or (CompanyName like @searchValue) or (ContactName like @searchValue) or(Phone like @searchValue)
                                          ) as t
                                          where	(@pageSize =-1) or
